...
FBPIC-EWP, short for Fourier-Bessel Particle-In-Cell Electric Work Profiler, is a tool designed to estimate the work performed by the Laser and Plasma fields on tracked electrons in FBPIC (Fourier-Bessel Particle-In-Cell) simulations.
